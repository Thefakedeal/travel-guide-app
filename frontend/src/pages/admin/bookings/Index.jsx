...
export default function Index() {
 ...
 return (
   <div className="container py-2">
       {selectedId && <Assign bookingId={selectedId} handleClose={close} handleSuccess={refresh} visible={visible}/>}
           ...
           <tbody>
               {
                   data.data.map((booking,index)=>(
                       <tr key={booking.id}>
                           ...
                           <td>
                               {booking.plan.name} - {booking.plan.days} Days - Rs. {booking.plan.price}
                           </td>
                       </tr>
                   ))
               }
